...
static constexpr auto qt_meta_stringdata_ZN16ConnectionWidgetE = QtMocHelpers::stringData(
    "ConnectionWidget",
    "tableActivated",
    "",
    "table",
...
Q_CONSTINIT static const uint qt_meta_data_ZN16ConnectionWidgetE[] = {
...
Q_CONSTINIT const QMetaObject ConnectionWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16ConnectionWidgetE.offsetsAndSizes,
    qt_meta_data_ZN16ConnectionWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16ConnectionWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void ConnectionWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ConnectionWidget::*)(const QString & );
            if (_q_method_type _q_method = &ConnectionWidget::tableActivated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (ConnectionWidget::*)(const QString & );
            if (_q_method_type _q_method = &ConnectionWidget::metaDataRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *ConnectionWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16ConnectionWidgetE.stringdata0))
